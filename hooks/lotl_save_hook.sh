#!/usr/bin/env bash
# Lotl Save Hook for Claude Code / OpenClaw
#
...
#     "Stop": [{
#       "matcher": "*",
#       "hooks": [{"type": "command", "command": "/path/to/hooks/lotl_save_hook.sh", "timeout": 30}]
#     }]
#   }
# }

SAVE_INTERVAL="${LOTL_SAVE_INTERVAL:-15}"
STATE_DIR="${HOME}/.config/lotl/hook_state"
mkdir -p "$STATE_DIR"
