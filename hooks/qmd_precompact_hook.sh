#!/usr/bin/env bash
# QMD PreCompact Hook for Claude Code / OpenClaw
#
...
#   "hooks": {
#     "PreCompact": [{
#       "hooks": [{"type": "command", "command": "/path/to/hooks/qmd_precompact_hook.sh", "timeout": 30}]
#     }]
#   }
# }

LOG_FILE="${HOME}/.config/qmd/hook_state/hook.log"
