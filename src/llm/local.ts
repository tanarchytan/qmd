/**
 * llm/local.ts — local node-llama-cpp LLM implementation.
 *
 * The LlamaCpp class + its default-singleton lifecycle (including the
 * session manager that coordinates its idle-unload timer) live here.
 * Fully self-contained: types come from ./types, model loading from
 * ./loader, session machinery from ./session. Nothing imports back
 * through ./llm.js so the facade can freely re-export from this file.
 */
...
import { LLMSession, LLMSessionManager } from "./session.js";

// Type aliases (erased at compile time, no runtime import of node-llama-cpp)
type Llama = any;
type LlamaModel = any;
...
// =============================================================================
// LlamaCpp class — node-llama-cpp LLM implementation
// =============================================================================
...
// =============================================================================
// Default LlamaCpp singleton + session coordination
// =============================================================================
...
/**
 * Execute a function with a scoped LLM session bound to the default LlamaCpp.
 * The session provides lifecycle guarantees — resources won't be disposed
 * mid-operation.
 *
 * @example
 * ```typescript
 ...
 * Used internally by LlamaCpp's idle timer.
 */
